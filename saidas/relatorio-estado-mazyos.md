...
- **Design/UI/UX:** frontend-design, ui-ux-pro-max, refactoring-ui, web-typography, top-design, design-everyday-things, microinteractions, design-is, design-sprint, impeccable, steve-jobs-design-review, ux-heuristics.
...
- **Estratégia/produto:** jobs-to-be-done, mom-test, lean-startup, lean-ux, lean-analytics, blue-ocean-strategy, good-strategy-bad-strategy, inspired-product, continuous-discovery, obviously-awesome, negotiation.
  *(ios-hig-design, crossing-the-chasm, traction-eos, cold-start-problem, monetizing-innovation e predictable-revenue removidas na auditoria de skills — ver `CLAUDE.md` raiz)*
